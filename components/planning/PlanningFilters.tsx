      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            disabled={isLoading}
            className="w-full bg-[#2A1B45] text-seasalt border border-accent/20 rounded-lg pl-10 pr-4 py-2 text-sm placeholder:text-seasalt/50 focus:outline-none focus:ring-2 focus:ring-sgbus-green/50 disabled:opacity-50"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <select 
            ...
            disabled={isLoading}
            className="bg-[#2A1B45] text-seasalt border border-accent/20 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-sgbus-green/50 disabled:opacity-50"
          >
          ...
          {activeFiltersCount > 0 && (
            <button
              ...
              disabled={isLoading}
              className="p-2 text-seasalt/70 hover:text-seasalt transition-colors disabled:opacity-50"
